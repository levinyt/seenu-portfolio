        ...
        <RevealOnScroll>
            <div className="text-center z-10 px-4">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                    I'm a full stack web developer focused on building fast,responsive,and scalable
                     web applications from intutive front-end interfaces
                      to powerful back-end systems.
                </p>
